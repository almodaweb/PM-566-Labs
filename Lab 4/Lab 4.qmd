...
ggplot(data = met_avg_filtered, aes(x = factor(temp), y = wind.sp, color = region)) +
  geom_beeswarm(cex = 2, priority = "density", size = 3) +  # Beeswarm points
  labs(title = "Wind Speed Distribution by Temperature and Region",
       x = "Temperature (°C)",
       y = "Wind Speed (m/s)") +
  theme_minimal() +
