...
#### Viewing the structure of the actor table
```{sql, connection=con}
...
#### Viewing the structure of the rental table
```{sql connection=con, echo=FALSE, warning=FALSE}
...
#### Viewing the structure of the payment table
```{sql connection=con, echo=FALSE, warning=FALSE}
...
#### Viewing the structure of the customer table
```{sql connection=con, echo=FALSE, warning=FALSE}
